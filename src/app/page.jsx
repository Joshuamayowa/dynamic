...
export default function page() {
 ...
 const list =  filteredCourse.length > 0 ? filteredCourse.map(course => (
    ...
    <section key={course.id} className='flex flex-col text-left border-4 border-orange p-4 rounded-xl'>
  ...
  return (
    ...
    className='w-1/2 m-auto p-4 mt-5 out-of-none border-sky-800 border-4 rounded-lg'
     value={item}
    onChange={onChange}/>
    
    <div className='text-[20px] grid md grid-cols-4'>
      {list}
    </div>
    </div>
